...
import { addCartItem, getProductsData, getUserByUid } from "@/lib/supabase/fetch-data";
import { useEffect, useState } from "react";
import { auth } from "@/lib/firebase/config";
import { calculateTotalPrice, totalPriceSelector } from "@/store/slices/totalPrice";
